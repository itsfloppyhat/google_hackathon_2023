...
import 'package:google_hackathon_2023/running_screens/running.dart';
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => Running()));
          },
          label: const Text('GO'),
          backgroundColor: Color.fromRGBO(172, 237, 81, 1.0),
        ),
      ),
